...
%¹Ì¶¨C
for i=1:1000
    Cprev_pers(i)=(corrcoef(pers_mat_fre(i,foot_C),prev_mat_fre(i,foot_C))*[0;1])'*[1;0];
    Cprev_conn(i)=(corrcoef(conn_mat_fre(i,foot_C),prev_mat_fre(i,foot_C))*[0;1])'*[1;0];
%     Cprev_nest(i)=(corrcoef(nest(i,foot_C),prev_mat_fre(i,foot_C))*[0;1])'*[1;0];
%     Cprev_modu(i)=(corrcoef(modu(i,foot_C),prev_mat_fre(i,foot_C))*[0;1])'*[1;0];
    Cprev_dive(i)=(corrcoef(dive_mat_fre(i,foot_C),prev_mat_fre(i,foot_C))*[0;1])'*[1;0];
    
    Pprev_pers(i)=(corrcoef(pers_mat_fre(i,foot_P),prev_mat_fre(i,foot_P))*[0;1])'*[1;0];
    Pprev_conn(i)=(corrcoef(conn_mat_fre(i,foot_P),prev_mat_fre(i,foot_P))*[0;1])'*[1;0];
%     Pprev_nest(i)=(corrcoef(nest(i,foot_P),prev_mat_fre(i,foot_P))*[0;1])'*[1;0];
%     Pprev_modu(i)=(corrcoef(modu(i,foot_P),prev_mat_fre(i,foot_P))*[0;1])'*[1;0];
    Pprev_dive(i)=(corrcoef(dive_mat_fre(i,foot_P),prev_mat_fre(i,foot_P))*[0;1])'*[1;0];
    Mprev_pers(i)=(corrcoef(pers_mat_fre(i,foot_M),prev_mat_fre(i,foot_M))*[0;1])'*[1;0];
    Mprev_conn(i)=(corrcoef(conn_mat_fre(i,foot_M),prev_mat_fre(i,foot_M))*[0;1])'*[1;0];
%     Mprev_nest(i)=(corrcoef(nest(i,foot_M),prev_mat_fre(i,foot_M))*[0;1])'*[1;0];
%     Mprev_modu(i)=(corrcoef(modu(i,foot_M),prev_mat_fre(i,foot_M))*[0;1])'*[1;0];
    Mprev_dive(i)=(corrcoef(dive_mat_fre(i,foot_M),prev_mat_fre(i,foot_M))*[0;1])'*[1;0];

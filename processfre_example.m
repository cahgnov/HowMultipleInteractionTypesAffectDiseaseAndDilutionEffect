%process of simulation for a community with fd-transimision
...
sigma_3=0.01;%adjust strength of infectious ability,
...
%% simulation
tspan = [0 30000];;%steps of simulation
...
[t,y]=ode45(@(t,y) model_ode_fre(t,y,n,beta,r,nu,matrix_c,matrix_p,matrix_m,h,delta,rho),tspan,y0,options);biomass_min = 0.1;
